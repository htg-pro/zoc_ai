...
function supervisorState(status: LlamaCppStatus): "stopped" | "starting" | "ready" | "error" {
...
export type RunGate = { canStart: true } | { canStart: false; code: RunGateCode; message: string };
